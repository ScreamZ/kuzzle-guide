    ...
    $.widget("toc.tocify", {
        ...
        _setActiveElement: function(pageload) {
            ...
            var self = this,
                ...
                scrollToElem = $(elem).closest('.tocify-header');

            // Highlights current header
            scrollToElem.addClass('header-active');
       ...
       // _setEventHandlers
        ...
        _setEventHandlers: function() {
            ...
            this.element.on("click.tocify", "li", function(event) {
                ...
                // Removes highlighting from headings
                $('.tocify-header').removeClass('header-active');

                var scrollToElem = $(this).closest('.tocify-header');
